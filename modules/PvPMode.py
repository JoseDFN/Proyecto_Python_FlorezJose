...
import modules.utils.matches as mat  # Funciones para gestionar partidas en modo PvP

def menuPvP(*game):  # Función para gestionar el menú de Jugador vs Jugador (PvP)
    isPlayer = True  # Controla el bucle del menú
    userOpPvP = int(0)  # Opción del usuario, inicializada en 0
    
    while isPlayer:  # Bucle para mostrar el menú
        clp.limpiar()  # Limpia la pantalla
        print(msg.MenuJvJ)  # Muestra el menú de opciones

        try:
            userOpPvP = int(input('Ingrese la opcion: '))  # Solicita opción al usuario
            ...
            try:
                ...
                match userOpPvP:
                    ...
                    case 2:  # Iniciar sesión jugador 1
                        ch.loginP1()
                    case 3:  # Iniciar sesión jugador 2
                        ch.loginP2()
                    case 4:  # Iniciar partida en modo PvP
                        mat.modePvP()
